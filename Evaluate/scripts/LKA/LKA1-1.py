...
def get_report(scenario, script_id):
    ...
    score_description = '1) dis_deviation≤0.2m，且自车最大横向加速度≤2.3m/s²，得分100；\n' \
                        '2) 0.2<dis_deviation≤0.4m，且自车最大横向加速度≤2.3m/s²，得分70；\n' \
                        '3)0.4<dis_deviation，自车最大横向加速度≤2.3m/s²，且自车未驶离本车道，得分50；\n' \
