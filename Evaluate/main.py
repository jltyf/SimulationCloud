...
if __name__ == '__main__':
    result = scenario_score('D:/nc_lka_0825_1/nc_lka_0825_1\lka_0824_1_1(2)/Ego.csv', 'D:/评分脚本test_data/combined_ogt_FSRA_2_1_1.csv', ScenarioType.natural.value, 'GSLKA_1')
