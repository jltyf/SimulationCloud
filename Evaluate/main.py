...
if __name__ == '__main__':
    result = scenario_score('/home/server/Downloads/test_组合功能评分脚本_DATA/aeblka_1(5)/Ego.csv', '/home/server/Downloads/test_组合功能评分脚本_DATA/aeblka_1(5)/evaluation.csv', ScenarioType.natural.value, 'GSACCLKA_1')
