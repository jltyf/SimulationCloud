...
class ScenarioGenerator():
    ...
    def _create_folder_structure(self,generation_folder):
        ...
        xosc_folder = generation_folder
        xodr_folder = generation_folder
    ...
    def _generate_road_and_scenario(self,permutation):
        ...
        # scenario_name = self._generation_folder.split('/')
        # scenario_name = scenario_name[len(scenario_name) - 1]
        scenario_name = os.path.basename(self._generation_folder)
        self.road_file = ''
        scenario_file = ''
        ...
        if road:
            ...
            if new_unique_road:
                ...
                self.road_file = os.path.abspath(os.path.join(self._generation_folder, scenario_name + '.xodr'))
                ...
                if self.write_relative_road_path:
                    ...
                    self.road_file = self.road_file.replace(os.path.abspath(self._generation_folder), '')
        ...
        if sce:
            ...
            scenario_file = os.path.join(self._generation_folder, scenario_name + '.xosc')
